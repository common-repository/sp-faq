...
<div id="wp_faq_unlock_tabs" class="wp-faq-vtab-cnt wp_faq_unlock_tabs wp-faq-clearfix">
	...
	<div class="wp-faq-favourite-section">
		<h3 class="wp-faq-blue wp-faq-favourite-heading">Use Essential Plugin Bundle</h3>
		<h1 class="wp-faq-favourite-sub-heading">With Your Favourite Page Builders</h1>
		<span><i class="dashicons dashicons-yes"></i> = <img src="<?php echo esc_url( WP_FAQ_URL ); ?>assets/images/essential-logo-small.png" width="15" height="15" /> Essential Plugin Bundle contain many more layouts and designs</span>
	</div>
